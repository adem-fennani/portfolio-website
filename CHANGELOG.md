...
### Fixed
- Fixed footer display issues by replacing text labels with inline icons for a cleaner look.

## [0.6.0] - 2026-06-25

### Added
- Added contact details to the footer.
- Added an Experience section detailing past internships.

## [0.5.1] - 2026-06-15

### Changed
- Updated CV (`cv.pdf`) and renamed the old cv to `cv_v1.pdf`.
